...
import com.hyperfactions.gui.data.FactionDashboardData;
...
public class FactionDashboardPage extends InteractiveCustomUIPage<FactionDashboardData> {
    ...
    public void build(Ref<EntityStore> ref, UICommandBuilder cmd,
        ...
        cmd.append("HyperFactions/faction_dashboard.ui");
    ...
    private void buildStatCards(UICommandBuilder cmd) {
        ...
        // Power card
        cmd.append("#PowerCard", "HyperFactions/dashboard_stat_card.ui");
        ...
        // Claims card
        cmd.append("#ClaimsCard", "HyperFactions/dashboard_stat_card.ui");
        ...
        // Members card
        cmd.append("#MembersCard", "HyperFactions/dashboard_stat_card.ui");
    ...
    private void buildQuickActions(UICommandBuilder cmd, UIEventBuilder events,
        ...
        if (faction.hasHome()) {
            cmd.append("#HomeBtnContainer", "HyperFactions/dashboard_action_btn.ui");
        ...
        if (isOfficerPlus) {
            cmd.append("#ClaimBtnContainer", "HyperFactions/dashboard_action_btn.ui");
        ...
        cmd.append("#FChatBtnContainer", "HyperFactions/dashboard_action_btn.ui");
        ...
        cmd.append("#AChatBtnContainer", "HyperFactions/dashboard_action_btn.ui");
        ...
        if (!isLeader) {
            cmd.append("#LeaveBtnContainer", "HyperFactions/dashboard_action_btn.ui");
    ...
    private void buildActivityFeed(UICommandBuilder cmd, UIEventBuilder events) {
        ...
        for (int i = 0; i < displayCount; i++) {
            ...
            cmd.append(containerId, "HyperFactions/activity_entry.ui");
