...
import com.hyperfactions.gui.data.PlayerInfoData;
...
public class PlayerInfoPage extends InteractiveCustomUIPage<PlayerInfoData> {
    ...
    public void build(Ref<EntityStore> ref, UICommandBuilder cmd,
        ...
        cmd.append("HyperFactions/player_info.ui");
        ...
        // === Basic Info Section ===
        cmd.append("#BasicInfoSection", "HyperFactions/info_section.ui");
        ...
        cmd.append("#BasicInfoSection #SectionContent", "HyperFactions/info_row.ui");
        ...
        cmd.append("#FactionInfoSection", "HyperFactions/info_section.ui");
        cmd.set("#FactionInfoSection #SectionTitle.Text", "Faction");

        if (faction != null && member != null) {
            // Faction name
            cmd.append("#FactionInfoSection #SectionContent", "HyperFactions/info_row.ui");
            ...
            // View faction button
            cmd.append("#FactionInfoSection #SectionContent", "HyperFactions/action_button.ui");
        ...
        // === Power Section ===
        cmd.append("#PowerSection", "HyperFactions/info_section.ui");
        cmd.set("#PowerSection #SectionTitle.Text", "Power");

        PlayerPower power = powerManager.getPlayerPower(targetPlayerUuid);
        if (power != null) {
            // Current power
            cmd.append("#PowerSection #SectionContent", "HyperFactions/info_row.ui");
            ...
            cmd.append("#PowerSection #SectionContent", "HyperFactions/progress_bar.ui");
