...
import com.hyperfactions.gui.data.LogsViewerData;
...
public class LogsViewerPage extends InteractiveCustomUIPage<LogsViewerData> {
    ...
    public void build(Ref<EntityStore> ref, UICommandBuilder cmd,
        ...
        cmd.append("HyperFactions/logs_viewer.ui");
        ...
        // === Filter Section ===
        cmd.append("#FilterSection", "HyperFactions/filter_section.ui");
        cmd.set("#FilterSection #FilterLabel.Text", "Filter:");

        // All logs filter
        cmd.append("#FilterSection #FilterButtons", "HyperFactions/filter_button.ui");
